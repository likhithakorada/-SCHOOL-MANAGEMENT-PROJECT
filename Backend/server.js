...
// app.use('/studentenroll',studentenrollRouter);
// app.use('/grades',gradeRouter);
// app.use('/FeeStructure',feeRouter);
...
const grades = require('./modules/grademodel');
const FeeStructure = require('./modules/feemodel');
const studentEnrollment = require('./modules/studentenrollmodel')
const app = express();
const jwt = require('jsonwebtoken');
const middleware = require('./middleware');
const cors = require('cors');
...
app.use('/academics', academicRouter);
app.use('/studentEnrollment',studentenrollRouter);
app.use('/grades',gradeRouter);
